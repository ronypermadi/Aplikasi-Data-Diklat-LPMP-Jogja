                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Welcome</strong> Login Page</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form  action="login.php" method="post" class="login-form">
			                        ...
			                        <button type="submit" align="center" class="btn" name="login" value="Login">Login</button>
			                    </form>
		                    </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 social-login">
                            ...
                            <button type="submit" align="center" class="btn">Create an account</button>
                            </form>
                        </div>
                    </div>
                </div>
