          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                          <li><a href="lihat_biodata.php">Biodata Peserta</a>
                          <li><a  href="lihat_diklat.php">Diklat</a></li>
                          <li><a  href="lihat_pengajar.php">Pengajar</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                          <li><a  href="input_biodata.php">Biodata Peserta</a></li>
                          <li><a  href="input_diklat.php">Diklat</a></li>
                          <li><a  href="input_pengajar.php">Pengajar</a></li>
              </ul>
            </li>
            <li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                          <li><a  href="input_admin.php">Input Admin</a></li>
                          <li><a  href="lihat_admin.php">Lihat Admin</a></li>
              </ul>
            </li>
          </ul>
        </section>
