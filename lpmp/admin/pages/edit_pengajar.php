...
$kode_wi = $_GET['kode_wi'];

if (isset($_GET['kode_wi'])) {
  $pengajar = pengajar_id($kode_wi);
   while ($row= mysqli_fetch_assoc($pengajar)){
    $kode_wi = $row['kode_wi'];
  $nama_wi = $row['nama_wi'];
  $mapel = $row['mapel'];
   }
...
if (isset($_POST['submit'])) {
  ...
  if (!empty(trim($kode_wi)) && !empty(trim($nama_wi))) {
    if (edit_pengajar($kode_wi, $nama_wi, $mapel)) {
...
<!-- Advanced Tables -->
                  ...
                  <form action="" method=POST enctype="multipart/form-data" role="form">
                    <div class="form-group">
                                            ...
                                            <input class="form-control" name="kode_wi" value="<?=$kode_wi; ?>">
                                        </div>
                    <div class="form-group">
                                            <label>Nama Pengajar :</label>
                                            <input class="form-control" name="nama_wi" value="<?=$nama_wi; ?>">
                                        </div>
                    <div class="form-group">
                                            <label>Mata Pelajaran :</label>
                                            <input class="form-control" name="mapel" value="<?=$mapel; ?>">
                                        </div>
