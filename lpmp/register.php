                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Welcome</strong> Register Form</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form  action="register_save.php" method="post" class="login-form">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="form-nama">Nama</label>
                                        <input type="text" name="nama" placeholder="Nama..." class="form-nama form-control" id="form-nama">
                                    </div>
			                        <button type="submit" align="center" class="btn" name="register" value="Login">Register</button>
			                    </form>
		                    </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 social-login">
                            ...
                            <button type="submit" align="center" class="btn">Login Now</button>
                            </form>
                        </div>
                    </div>
                </div>
